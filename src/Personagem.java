...
public class Personagem extends Pane{
    Image personagemImg = new Image(getClass().getResourceAsStream("personagem.png"));
    ImageView imageView = new ImageView(personagemImg);
    int count = 3;
    int columns = 3;
    int offsetX = 96;
    int offsetY = 33;
    ...
    public Personagem(){
        ...
        animation = new Animacao(this.imageView,Duration.millis(200),count,columns,offsetX,offsetY,width,height);
    ...
    public void moveY(int value){
        ...
        for(int i = 0; i < Math.abs(value); i++){
            for(Blocos platform :Game.platforms){
